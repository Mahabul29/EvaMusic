...
.np-artist-row i { font-size:12px; }
#npArtistLabel {
    white-space:nowrap;overflow:hidden;text-overflow:ellipsis;
}
#npLikeBtn {
...
/* ── Seek bar ── */
.np-seek-wrap {
    margin:20px 0 6px;cursor:pointer;
...
.np-ctrl-btn:active { opacity:0.4; }
.np-play-btn {
...
<div id="npBg">
  ...
  <div id="npScroll">
    ...
    <div class="np-chevron">
      <button onclick="closePlayerOverlay()">
    ...
    <!-- Album Art -->
    <img id="npAlbumArt"
         src="/static/images/default-album.png"
         onerror="this.onerror=null;this.src='/static/images/default-album.png';"
         alt="Album Art">
    ...
    <div class="np-controls">
      <button class="np-ctrl-btn" id="npShuffleBtn" onclick="window.player.toggleShuffle();this.classList.toggle('active',window.player.isShuffle)">
      ...
      <button class="np-ctrl-btn" id="npRepeatBtn" onclick="window.player.toggleRepeat();_npSyncRepeatBtn()">
    ...
    <!-- Bottom toolbar: Lyrics | Queue | Save | Share | Sleep -->
    ...
    // Sync shuffle/repeat button states
...
function _npSyncRepeatBtn() {
    ...
    if (icon) icon.className = mode === 2 ? 'fas fa-redo' : 'fas fa-redo';
