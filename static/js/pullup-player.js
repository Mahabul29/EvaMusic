...
#npAlbumArt{width:100%;aspect-ratio:1/1;max-width:100%;border-radius:16px;object-fit:cover;box-shadow:0 16px 48px rgba(0,0,0,0.7);display:block;margin:8px auto 22px;flex-shrink:0}
...
.np-seek-wrap{margin:18px 0 5px;cursor:pointer;padding:8px 0;position:relative}
...
.np-controls{display:flex;align-items:center;justify-content:space-between;margin-bottom:24px}
...
.np-server-row{display:flex;justify-content:center;align-items:center;gap:10px;margin-bottom:14px}
.np-server-label{color:rgba(255,255,255,0.4);font-size:11px;font-weight:600;letter-spacing:1px;text-transform:uppercase}
.np-server-btn{background:rgba(255,255,255,0.08);border:1.5px solid rgba(255,255,255,0.15);color:rgba(255,255,255,0.55);font-size:12px;font-weight:600;padding:5px 18px;border-radius:20px;cursor:pointer;-webkit-tap-highlight-color:transparent;transition:all .2s;letter-spacing:0.5px}
.np-server-btn.active{background:rgba(29,185,84,0.18);border-color:#1db954;color:#1db954}
.np-toolbar-divider{height:1px;background:rgba(255,255,255,0.1);margin:0 0 14px}
.np-toolbar{display:flex;justify-content:space-around;align-items:center;padding-bottom:6px}
.np-tool-btn{background:none;border:none;color:rgba(255,255,255,0.6);font-size:20px;cursor:pointer;display:flex;flex-direction:column;align-items:center;gap:5px;-webkit-tap-highlight-color:transparent;transition:color .15s;min-width:48px}
.np-tool-btn span{font-size:11px;font-weight:500;color:rgba(255,255,255,0.45)}
.np-tool-btn:active{color:#fff}
.np-tool-btn:active span{color:rgba(255,255,255,0.8)}
</style>
...
<div id="npBg">
  ...
  <div id="npScroll">
    ...
    <!-- Server selector -->
    <div class="np-server-row">
      <span class="np-server-label">Server</span>
...
function _npSetServer(num) {
    ...
    // Re-play current song on new server if playing
