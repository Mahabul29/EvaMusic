...
.np-toolbar-divider{height:1px;background:rgba(255,255,255,0.1);margin:0 0 12px}
/* Single bottom row with server pills + action buttons */
.np-toolbar{display:flex;justify-content:space-around;align-items:center;padding-bottom:6px;gap:4px}
.np-tool-btn{background:none;border:none;color:rgba(255,255,255,0.6);font-size:19px;cursor:pointer;display:flex;flex-direction:column;align-items:center;gap:4px;-webkit-tap-highlight-color:transparent;transition:color .15s;min-width:0;flex:1}
...
/* Server pill buttons in toolbar */
.np-srv-wrap{display:flex;flex-direction:column;align-items:center;gap:4px;flex:1;cursor:pointer}
.np-srv-wrap span{font-size:10px;font-weight:500;color:rgba(255,255,255,0.42);white-space:nowrap}
.np-server-btn{background:rgba(255,255,255,0.1);border:1.5px solid rgba(255,255,255,0.18);color:rgba(255,255,255,0.55);font-size:11px;font-weight:700;padding:4px 12px;border-radius:20px;cursor:pointer;-webkit-tap-highlight-color:transparent;transition:all .2s;letter-spacing:0.4px;white-space:nowrap}
.np-server-btn.active{background:rgba(29,185,84,0.2);border-color:#1db954;color:#1db954}
/* Server pair inline */
.np-srv-pills{display:flex;gap:5px;align-items:center}
</style>
...
<div id="npBg">
  ...
  <div id="npScroll">
    ...
    <!-- Single row: Server pills | Queue | Save | Share | Sleep -->
    <div class="np-toolbar">

      <!-- Server HD-1 / HD-2 as one toolbar slot -->
      <div class="np-srv-wrap">
        <div class="np-srv-pills">
