...
# Import from app (avoid circular import at module level)
def _get_app_funcs():
    import app
    return (
        app.fetch_songs,
        app._normalize_song,
        app._filter_by_language,
        app._detect_song_language,
        app.LANG_INDICATORS,
        app.ARTIST_LANG_MAP,
    )
...
def get_similar_songs(song, limit=10):
    ...
    fetch_songs, _normalize_song, _filter_by_language, _detect_song_language, LANG_INDICATORS, ARTIST_LANG_MAP = _get_app_funcs()
...
def get_similar_artists(artist_name, limit=5):
    ...
    _, _normalize_song, _, _detect_song_language, LANG_INDICATORS, ARTIST_LANG_MAP = _get_app_funcs()
